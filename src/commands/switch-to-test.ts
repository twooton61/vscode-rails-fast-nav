...
import { testMaker, specMaker, inverseTestMaker, requestSpecMaker } from '../makers';
...
export async function switchToTest() {
  return getRailsContext([testMaker, specMaker, requestSpecMaker, inverseTestMaker], async function(railsFile, workspace, switchFiles) {
    if (railsFile.isTest()) {
